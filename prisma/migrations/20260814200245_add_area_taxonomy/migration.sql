...
INSERT INTO "new_Bug" ("actualResult", "area", "assignedToId", "buildId", "createdAt", "description", "environmentGpu", "environmentOS", "expectedResult", "gameId", "gameMode", "id", "isRegression", "map", "priority", "reportedById", "sessionId", "severity", "status", "stepsToReproduce", "title", "updatedAt") SELECT "actualResult", "area", "assignedToId", "buildId", "createdAt", "description", "environmentGpu", "environmentOS", "expectedResult", "gameId", "gameMode", "id", "isRegression", "map", "priority", "reportedById", "sessionId", "severity", "status", "stepsToReproduce", "title", "updatedAt" FROM "Bug";
DROP TABLE "Bug";
...
INSERT INTO "new_TestCase" ("category", "createdAt", "description", "expected", "gameId", "id", "platform", "preconditions", "priority", "steps", "title") SELECT "category", "createdAt", "description", "expected", "gameId", "id", "platform", "preconditions", "priority", "steps", "title" FROM "TestCase";
DROP TABLE "TestCase";
