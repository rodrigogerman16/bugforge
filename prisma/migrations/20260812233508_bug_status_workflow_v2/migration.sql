...
INSERT INTO "new_Bug" ("area", "assignedToId", "buildId", "createdAt", "description", "gameId", "id", "reportedById", "sessionId", "severity", "status", "stepsToReproduce", "title", "updatedAt") SELECT "area", "assignedToId", "buildId", "createdAt", "description", "gameId", "id", "reportedById", "sessionId", "severity", "status", "stepsToReproduce", "title", "updatedAt" FROM "Bug";
DROP TABLE "Bug";
